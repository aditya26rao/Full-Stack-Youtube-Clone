...
export function LoginPage({ onLogin }) {
  ...
  return (
    <form
      ...
      onSubmit={submit}
    >
      <h2 className="text-2xl font-semibold text-neutral-900 dark:text-neutral-100">Sign in</h2>
      ...
      <p className="text-sm text-neutral-600 dark:text-neutral-400">
        No account?{" "}
        <Link className="font-medium text-red-600 dark:text-red-400" to="/register">
          Register
        </Link>
      </p>
    </form>
